...
- MCP сервер с двумя инструментами
...
Для работы инструмента `get-weather` необходим API-ключ OpenWeatherMap, указанный в переменной окружения `OPEN_WEATHER` в файле `.env`.
